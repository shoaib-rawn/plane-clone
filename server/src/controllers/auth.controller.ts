...
export const forgotPasswordController = asyncHandler(async (req: Request, res: Response) => {
  ...
  const result = await authService.requestPasswordReset(validatedBody.email, clientOrigin);
...
export const resetPasswordController = asyncHandler(async (req: Request, res: Response) => {
  ...
  const result = await authService.resetPassword(validatedBody.token, validatedBody.password);
